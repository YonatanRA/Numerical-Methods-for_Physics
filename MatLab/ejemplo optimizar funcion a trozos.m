...
yd=yd+xd.*randn(1,100)/50; %yd=yd+randn(1,100)/10 es otra manera de distorsionar...un poco mayor
...
c=input(' estimacion del vector de coeficientes ->'); %pide el input de la semilla
hold on
